...
static struct dvb_usb_device_properties af9035_properties[] = {
	{
		...
		.devices = {
			{
				.name = "Afatech AF9035 DVB-T USB2.0 stick - By ItalySat.it",
